    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_form', models.IntegerField(choices=[(1, 'Text'), (2, 'Boolean'), (3, 'Integer')])),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(check=models.Q(models.Q(('data_bool__isnull', False), ('data_form', 2), ('data_int__isnull', True), ('data_text__isnull', True)), models.Q(('data_bool__isnull', True), ('data_form', 1), ('data_int__isnull', True), ('data_text__isnull', False)), models.Q(('data_bool__isnull', True), ('data_form', 3), ('data_int__isnull', False), ('data_text__isnull', True)), _connector='OR'), name='data_type_constraint'),
        ),
    ]
